...
function performPatchTask(accessKey, appName, packagePath, appStoreVersion, deploymentName, description, rollout, isMandatory, isDisabled, targetBinaryVersion, label) {
  ...
  targetBinaryVersion = targetBinaryVersion || tl.getInput("targetBinaryVersion", false);
